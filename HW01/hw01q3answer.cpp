...
int main(){
    ...
    printf("In this context the variable y is a number and not a character. Therefore instead of formatting it as a character we have to format it as a number.\n\n");
